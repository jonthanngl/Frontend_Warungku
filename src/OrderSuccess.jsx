    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-6 font-sans">
      <div className="bg-white p-8 md:p-12 rounded-3xl shadow-xl max-w-lg w-full text-center border border-gray-100">
        ...
        <div className="bg-gray-50 rounded-2xl p-6 mb-8 border border-gray-100">
          ...
          <p className="text-3xl font-mono font-bold text-slate-800 tracking-wider select-all">{transactionCode || 'W-XXXXX'}</p>
        </div>

        <button 
          onClick={onBackMenu}
          className="w-full bg-slate-900 text-white py-4 rounded-xl font-bold text-lg shadow-lg hover:bg-black transition-all transform hover:scale-[1.02]"
        >
