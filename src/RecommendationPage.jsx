...
const RecommendationPage = ({ onSelectCategory, onSkip }) => {
  const suggestions = [
    ...
    { 
      ...
      desc: 'Porsi kuli, rasa bintang lima.', 
      icon: '🍚', 
    ...
    { 
      ...
      desc: 'Teman setia buat nonton atau kerja.', 
      icon: '🍿', 
  ...
  return (
    <div className="min-h-screen bg-warung-secondary flex flex-col items-center justify-center p-6 animate-fade-in-up">
      <div className="max-w-2xl w-full text-center">
        <span className="text-warung-primary font-bold tracking-widest uppercase text-xs mb-3 block">Rekomendasi Pintar</span>
        <h2 className="text-4xl font-black text-gray-900 mb-4 tracking-tight">Bingung Mau Makan Apa?</h2>
        <p className="text-gray-500 mb-10">Biar kami bantu pilihkan yang paling pas buat kamu saat ini.</p>
        ...
        <button 
          onClick={onSkip}
          className="mt-12 text-gray-400 font-bold hover:text-warung-primary transition-colors flex items-center gap-2 mx-auto"
        >
